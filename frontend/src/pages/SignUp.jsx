...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://propal-ai-assignment.onrender.com/api/signup', {
        method: 'POST',
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      ...
      <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md w-full max-w-md transition-all duration-300">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full cursor-pointer bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition duration-200"
          >
            Sign Up
          </button>
        </form>
        ...
        <div className="mt-4 text-center">
          ...
          <button
            ...
            className="text-blue-600 cursor-pointer hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 font-semibold transition duration-200"
          >
            Login
          </button>
        </div>
